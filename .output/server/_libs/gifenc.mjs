...
var gifenc_esm_exports = /* @__PURE__ */ __exportAll({
	GIFEncoder: () => ct,
	applyPalette: () => nt,
	quantize: () => H
});
...
function F(t = 256) {
	...
	function n(r) {
		var o = s.length;
		if (o >= r) return;
		r = Math.max(r, o * (o < 1048576 ? 2 : 1.125) >>> 0), o != 0 && (r = Math.max(r, 256));
		let c = s;
...
function ut(t, e) {
	let n = new Array(e === "rgb444" ? 4096 : 65536), r = t.length;
...
function H(t, e, s = {}) {
	...
	for (u = 0;; ++V) {
		...
		if (l) {
			if (E = R(Math.round(f[u].ac), 0, 255), c) E = E <= (typeof c == "number" ? c : 127) ? 0 : 255;
			r && E <= i && (L = C = Y = o, E = 0);
		}
		let K = l ? [
			L,
...
//#endregion
export { nt as i, ct as n, gifenc_esm_exports as r, H as t };
